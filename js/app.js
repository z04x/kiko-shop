(() => {
    ...
    tippy_esm("#pink", {
        content: 'Продукт, добавленный в <span style="color: pink;">избраное</span>',
        allowHTML: true,
        trigger: "click"
    });
    ...
    function initSliders() {
        ...
        if (document.querySelector(".s2")) new core(".s2", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".s3")) new core(".s3", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".s4")) new core(".s4", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".s5")) new core(".s5", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    document.querySelector("#elastic").oninput = function() {
        ...
        let opacityItem = document.querySelector(".page");
        if ("" != val) elasticItems.forEach((function(elem) {
            if (-1 == elem.innerText.search(val)) elem.classList.add("hide"); else {
                elem.classList.remove("hide");
                elem.classList.remove("display-none-for-card");
                opacityItem.classList.add("opasity-for-body");
            }
        })); else elasticItems.forEach((function(elem) {
            elem.classList.remove("hide");
            elem.classList.add("display-none-for-card");
            opacityItem.classList.remove("opasity-for-body");
        }));
    };
    window.onload = function() {
        let content = document.getElementById("content");
        let show = document.getElementById("show");
        if (show ?? null) show.onclick = function() {
            if ("open" == content.className) {
                content.className = "";
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (targetElement.classList.contains("icons-content__link-shop") || targetElement.closest(".icons-content__link-shop")) {
                ...
                e.preventDefault();
            } else if (!targetElement.closest(".icons-content__shop") && !targetElement.classList.contains("actions-product__button")) document.querySelector(".icons-content__shop").classList.remove("_active");
